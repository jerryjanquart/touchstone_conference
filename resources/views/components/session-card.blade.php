<div class="col-md-6">
   <div class="card shadow-sm h-100 border-0 card-lift overflow-hidden">
      <div class="row h-100 g-0">
         <a href="{{ $url }}" class="col-lg-5 col-md-12" style="background-image: url({{ $imgUrl }});background-size: cover; background-repeat: no-repeat;background-position: center;min-height: 13rem;"></a>
         <div class="col-lg-7 col-md-12">
            <div
               ...
               <div class="mb-5">
                  <small class="text-uppercase text-black fw-semibold ls-md">The 2025 Conference</small>
