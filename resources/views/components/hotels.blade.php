...
<section class="py-xl-8 py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="text-center mb-xl-7 mb-5">
                    <h2 class="text-black mb-3" style="font-family: 'Times New Roman', Times, serif; font-size: 2rem; font-weight: bold;">HOTEL ACCOMODATIONS</h2>
                </div>
            </div>
        </div>
