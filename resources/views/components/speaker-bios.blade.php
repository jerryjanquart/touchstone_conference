<!-- testimonails section -->
   ...
   <!-- TRY ALSO "CASE STUDY 1" -->
   <section class="py-xl-8 py-lg-7 py-5 bg-black">
                  ...
                  <div class="swiper-wrapper pb-lg-8 pb-6 pt-1">
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/kingsnorth.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/pageau.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                           <div class="col-lg-7 col-12 ms-lg-n10">
                              <div class="card">
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/crawford.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                           <div class="col-lg-7 col-12 ms-lg-n10">
                              <div class="card">
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/rohlin.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                           <div class="col-lg-7 col-12 ms-lg-n10">
                              <div class="card">
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/boersma.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                           <div class="col-lg-7 col-12 ms-lg-n10">
                              <div class="card">
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/young.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                           <div class="col-lg-7 col-12 ms-lg-n10">
                              <div class="card">
                     ...
                     <div class="swiper-slide">
                        <div class="row align-items-center gy-4">
                           <div class="col-lg-6">
                              <div class="">
                                 <img src="../assets/images/speakers/farrow.jpg" alt="" class="img-fluid rounded-3 w-100" />
                              </div>
                           </div>
                           <div class="col-lg-7 col-12 ms-lg-n10">
                              <div class="card">
